...
import { TemplateMarketplaceDashboard } from './components/TemplateMarketplaceDashboard';
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<'monitor' | 'replay' | 'templates'>('monitor');
