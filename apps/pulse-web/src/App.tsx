...
import { DeploymentImpactDashboard } from './components/DeploymentImpactDashboard';
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<'monitor' | 'replay' | 'deployments'>('monitor');
