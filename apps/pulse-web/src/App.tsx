...
import { TraceVisualizationDashboard } from './components/TraceVisualizationDashboard';
...
export default function App() {
  ...
  const [activeTab, setActiveTab] = useState<'monitor' | 'replay' | 'traces'>('monitor');
